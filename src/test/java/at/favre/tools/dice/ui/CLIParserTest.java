...
public class CLIParserTest {
    ...
    public void testSimpleDefaults() throws Exception {
        ...
        Arg expectedArg = Arg.create(Arg.DEFAULT_ENCODING, null, 67, null, false, false, false, false, false, false, null);
    ...
    public void testSimpleSeed() throws Exception {
        ...
        Arg expectedArg = Arg.create(Arg.DEFAULT_ENCODING, "ahdalsudzasldjhasdu", 128, null, false, false, false, false, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testPadding() throws Exception {
        ...
        Arg expectedArg = Arg.create(Arg.DEFAULT_ENCODING, null, 64, null, false, false, false, true, false, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testRobot() throws Exception {
        ...
        Arg expectedArg = Arg.create(Arg.DEFAULT_ENCODING, null, 64, null, false, false, false, false, true, false, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testCrc32() throws Exception {
        ...
        Arg expectedArg = Arg.create(Arg.DEFAULT_ENCODING, null, 12, null, false, false, false, false, false, true, null);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testOutFile() throws Exception {
        ...
        Arg expectedArg = Arg.create(Arg.DEFAULT_ENCODING, null, 12, null, false, false, false, false, false, false, new File(fileString));
        assertEquals(expectedArg, parsedArg);
    }
