...
public class CLIParserTest {
    ...
    public void testSimpleDefaults() throws Exception {
        ...
        Arg expectedArg = new Arg(Arg.DEFAULT_ENCODING, null, 67, null, false, false, false, false);
    ...
    public void testSimpleCount() throws Exception {
        ...
        Arg expectedArg = new Arg("testTest", null, 4, 1123, false, false, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testSimpleSeed() throws Exception {
        ...
        Arg expectedArg = new Arg(Arg.DEFAULT_ENCODING, "ahdalsudzasldjhasdu", 128, null, false, false, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testOnline() throws Exception {
        ...
        Arg expectedArg = new Arg(Arg.DEFAULT_ENCODING, null, 4, 1123, true, false, false, false);
        assertEquals(expectedArg, parsedArg);
    }
    ...
    public void testPadding() throws Exception {
        ...
        Arg expectedArg = new Arg(Arg.DEFAULT_ENCODING, null, 64, null, false, false, false, true);
        assertEquals(expectedArg, parsedArg);
    }
